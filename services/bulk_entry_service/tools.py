...
def update_bulk_entry(company: Company, transaction_no: str, data: dict, db: Session) -> dict:
    tables = table_names(company)
    EDITABLE = {
    ...
    updates = {k: v for k, v in data.items() if v is not None and k in EDITABLE}
