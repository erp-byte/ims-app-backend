...
def create_rtv_endpoint(
    ...
    return create_rtv(data, created_by, db)
...
def update_rtv_endpoint(
    ...
    return update_rtv(company, rtv_id, data, db)
...
def delete_rtv_endpoint(
    ...
    return delete_rtv(company, rtv_id, db)
...
def update_rtv_lines_endpoint(
    ...
    return update_rtv_lines(company, rtv_id, data, db)
...
def approve_rtv_endpoint(
    ...
    return approve_rtv(company, rtv_id, payload, db)
