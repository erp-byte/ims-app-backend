...
grab(); en.notify_rtv_created(DETAIL)
...
grab(); en.notify_rtv_approved(DETAIL, "head@candorfoods.in")
assert captured[0].get("in_reply_to") == KEY, ("approved", captured[0].get("in_reply_to"))

grab(); en.notify_rtv_weight_discrepancy(DETAIL, {"lines": [], "total_diff": 0})
assert captured[0].get("in_reply_to") == KEY, ("discrepancy", captured[0].get("in_reply_to"))

grab(); en.notify_rtv_deleted("CR-20260609120000", 1, "x@y.com",
